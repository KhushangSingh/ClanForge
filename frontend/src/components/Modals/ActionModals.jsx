...
export const ActionButton = ({ onClick, variant = 'primary', children, className }) => {
...
export const DisbandModal = ({ isOpen, onClose, onConfirm }) => (
  <Modal isOpen={isOpen} onClose={onClose} title="Disband Squad">
    <div className="flex flex-col items-center text-center">
      ...
      <p className="text-gray-400 font-medium mb-6 md:mb-8 text-sm md:text-base">This action cannot be undone. The clan will be gone forever.</p>
      <div className="grid grid-cols-2 gap-3 md:gap-4 w-full">
        <ActionButton onClick={onClose} variant="secondary">Cancel</ActionButton>
    ...
    <div className="flex flex-col items-center text-center">
      ...
      <div className="bg-rose-50 border border-rose-100 p-4 md:p-5 rounded-2xl mb-6 md:mb-8 text-left w-full">
        <ul className="space-y-2 md:space-y-3 text-xs md:text-sm text-rose-800 font-bold">
          <li className="flex items-start gap-3"><span className="mt-1.5 w-1.5 h-1.5 bg-rose-500 rounded-full shrink-0"></span>All your hosted clans will be disbanded.</li>
...
export const RequestSentModal = ({ isOpen, onClose }) => (
  <Modal isOpen={isOpen} onClose={onClose} title="Request Sent">
    <div className="flex flex-col items-center text-center">
      ...
      <p className="text-gray-400 font-medium mb-6 md:mb-8 text-sm md:text-base">The clan leader has been notified. Fingers crossed 🤞</p>
        ...
        <div className="space-y-3 md:space-y-4">
          ...
          <div>
              ...
              <textarea 
                ...
                placeholder="Briefly introduce yourself and why you want to join..." 
              />
          </div>
        </div>
